...
<head>
    ...
    <title>Administración San Javucho</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
                ...
                <div class="sidebar-brand-text mx-3">
                    <img src="/img/logoBlanco.png" alt="Logo San Javucho" width="100%" />
                </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Listado Completo</a>
                        <a class="collapse-item" href="cards.html">Carga/Actualización Múltiple</a>

                        <a class="collapse-item" href="cards.html">Producto Destacado</a>
            ...
            <!-- Nav Item - Secciones web Collapse Menu -->
            <li class="nav-item">
            ...
            <!-- Nav Item - Service Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUsoExterno"
                    aria-expanded="true" aria-controls="collapseUsoExterno">
                    <i class="fas fa-external-link-alt"></i>
                    <span>Uso Externo</span>
                </a>
                <div id="collapseUsoExterno" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span><a href="http://sanjavucho.com.ar" target="_blank">www.sanjavucho.com.ar</a></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
